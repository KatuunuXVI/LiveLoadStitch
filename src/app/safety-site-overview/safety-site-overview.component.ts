...
@Component({
  selector: 'app-safety-site-overview',
  templateUrl: './safety-site-overview.component.html',
  styleUrls: ['./safety-site-overview.component.scss', '../views/views.component.scss']
})




export class SafetySiteOverviewComponent implements OnInit {
