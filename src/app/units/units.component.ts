...
@Component({
  ...
  styleUrls: ['./units.component.css', '../views/views.component.scss']
})
export class UnitsComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private uServ: UnitsService, private map2: MapService) { }
